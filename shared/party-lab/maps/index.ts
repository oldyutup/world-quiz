...
/**
 * The only online map. Server authority and client prediction both build from
 * this; changing it requires a NET.version bump so stale clients refuse snapshots.
 */
