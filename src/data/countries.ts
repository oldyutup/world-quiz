...
export const COUNTRIES: CountryEntry[] = [
  ...
  { code:"cd", topoId:"180", display:"Kongo DR",                  counted:true,  difficulty:"easy",  continent:"africa", names:["kongo dr","demokratik kongo cumhuriyeti","dr congo","dem rep congo","democratic republic of the congo","drc"] },
  ...
  { code:"ma", topoId:"504", display:"Fas",                       counted:true,  difficulty:"easy",  continent:"africa", names:["fas","morocco","maroc"] },
  ...
  { code:"so", topoId:"706", display:"Somali",                    counted:true,  difficulty:"easy",  continent:"africa", names:["somali","somalia"] },
  ...
  { code:"us", topoId:"840", display:"ABD",                       counted:true,  difficulty:"easy",  continent:"north-america", names:["abd","usa","us","america","united states","united states of america","amerikan"] },
...
const EXTRA_ALIASES: Record<string, string[]> = {
  ...
  "Democratic Republic of Congo": ["kongo dr","demokratik kongo cumhuriyeti","dr congo","dem rep congo","democratic republic of the congo","drc","demokratik kongo"],
  ...
  "Uruguay":                  ["uruguay"],
  "Venezuela":                ["venezuela"],
  "USA":                      ["abd","usa","us","america","united states","united states of america","amerikan"],
