import { BUMPERS, PLATFORM, TEST_MAP } from "../../../../shared/party-lab/maps/test";
import { PLAYERS } from "../players";

/** The original temporary platform, kept for local debugging. */
export default function TestArena() {
  return (
    <group>
      ...
      {PLAYERS.map(player => (
        <mesh key={player.id} position={[TEST_MAP.spawns[player.id].x, 0.008, TEST_MAP.spawns[player.id].z]} rotation={[-Math.PI / 2, 0, 0]}>
