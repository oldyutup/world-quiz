...
/**
 * The Esc menu over an immersive arena (online Rooftop and Barn, local Katman Kaosu). It
...
export function controlHint(bindings: Bindings, mode: "rooftop" | "barn" | "layers", lookMode: LookMode = "lock") {
  const parts =
    mode === "layers"
      ? [
