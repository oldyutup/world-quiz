...
test("protocol 9: Renk Kaosu remains before Bomba Sende and Karışık in the compact picker", () => {
  assert.equal(NET.version, 9);
  assert.deepEqual([...MODE_SELECTIONS], ["rooftop_brawl", "barn_shootout", "layer_chaos", "color_chaos", "bomb_tag", "prop_hunt", "mixed"]);
