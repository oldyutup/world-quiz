...
const TURKEY_REGIONS: ConquestRegion[] = [
  ...
  },
  {
    ...
    mapId: "turkey",
    neighbors: ["dogu_karadeniz", "erzurum_kars"],
  ...
  },
  {
    ...
    name: "Ankara / Çevre",
    mapId: "turkey",
    neighbors: ["bati_karadeniz", "orta_karadeniz", "ic_bati_anadolu", "konya_karaman", "kapadokya"],
    displayLabel: "Ankara",
    emoji: "🏛️",
    groupName: "Orta Türkiye",
  },
  {
    ...
    name: "Orta Anadolu",
    mapId: "turkey",
    neighbors: ["orta_karadeniz", "kapadokya", "erzurum_kars", "malatya_elazig"],
  ...
  },
  {
    ...
    name: "Malatya / Elazığ",
    mapId: "turkey",
    neighbors: ["orta_anadolu", "kapadokya", "erzurum_kars", "van_hakkari", "firat_hatti"],
  ...
  // ── Row 3: Southern band ─────────────────────────────────────────────────
  {
    ...
    name: "Hatay / Osmaniye",
    mapId: "turkey",
    neighbors: ["cukurova", "antep_kilis"],
    displayLabel: "Hatay",
    emoji: "🕊️",
  ...
  },
  {
    ...
    name: "Çukurova",
    mapId: "turkey",
    neighbors: ["bati_akdeniz", "konya_karaman", "kapadokya", "hatay_osmaniye", "antep_kilis"],
  ...
  },
  {
    ...
    name: "Fırat Hattı",
    mapId: "turkey",
    neighbors: ["kapadokya", "malatya_elazig", "dicle_hatti", "antep_kilis"],
    displayLabel: "Fırat",
    emoji: "🏜️",
    groupName: "Güneydoğu",
  },
